...
if($_GET['proses']=='insert'){
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($db, "INSERT INTO dosen (nip,nama_dosen,email,prodi_id,telp,alamat)VALUES
            ('$_POST[nip]','$_POST[nama_dosen]','$_POST[email]','$_POST[prodi]','$_POST[telp]','$_POST[alamat]')");
        if ($sql) {
